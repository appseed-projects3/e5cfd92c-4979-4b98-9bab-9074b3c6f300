...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-05-21 04:01`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/e5cfd92c-4979-4b98-9bab-9074b3c6f300.git
$ cd e5cfd92c-4979-4b98-9bab-9074b3c6f300
```
